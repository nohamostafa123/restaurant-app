      ...
      >
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              <h1 className="text-gray-700 text-5xl sm:text-6xl lg:text-7xl font-bold">
                Welcome{" "}
                <span class="text-25xl sm:text-10xl text-green-700 font-bold">
                  Yamy
                </span>{" "}
                Zone
              </h1>
              ...
              <div>
                <button className="bg-green-700  hover:scale-105 hover:bg-yellow-500 duration-200 text-white py-2 px-4 rounded-full">
                  Order Now
                </button>
              </div>
            </div>
